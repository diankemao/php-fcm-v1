...
{
    public const KEY_FILE = 'service_account.json';
    ...
    public const DEVICE_TOKEN = 'dswH6YqIC70:APA91bFaFQM_Jw-hoQAYDwXOVN8ifuIQ_GCpT26h7mt_Q-bYc4g-7q8vQqYD5ILAPwuPbU5uk2kbQtYRyDvnnLHvG3cLMcppN41ri4rYAV-Daf4QyCj4l0anuYS-mXTq1j_yanLvhlCJ';

    public const TEST_TITLE = 'Testing from Code';

    public const TEST_BODY = 'Using phpFCMv1!';

    public const TEST_IMAGE = 'https://fastly.picsum.photos/id/982/300/200.jpg?hmac=rd0sm-A6tmsIiavEE2p9ynoCVr9RDUCjJMjqOH7_pvA';
     ...
     * @param $TEST_TITLE
     * @param $TEST_BODY
     * @param null|CommonConfig $config
     * @return Client
     */
